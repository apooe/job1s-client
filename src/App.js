    ...
    <div>
      <AppContext.Provider value={{ context, setContext }}>
        <BrowserRouter>
          ...
          <Switch>
            <Route exact path="/">
              {!context.isAuth ? <MainPage /> : <Home />}
            </Route>
            <Route exact path="/register">
              <RegisterForm isJobseeker={context.userType} />
            </Route>
            <Route exact path="/login">
              <LoginForm />
            </Route>
            <Route exact path="/status-definition">
              <SetUserRole />
            </Route>
            ...
            <ProtectedCondRoute
              ...
              componentTrue={ProfileRecruiter}
              componentFalse={ProfileUser}
            />
            <ProtectedRoute
              exact
