...
class JobPostsList extends Component {
    ...
    await http
      ...
      .then(({ data }) => {
        ...
        if (recruiters.length !== 0) {
          ...
          this.setState({
            currentJobPost: firstJp,
            currentRecruiter: recruiters[0],
          });
        } else {
  ...
  render() {
    ...
    const { recruiters, currentJobPost, currentRecruiter, onApply } =
      this.state;
    ...
    return (
      <div className="py-md-3">
        <div className="container  bg-light border rounded p-md-3">
          ...
          <div className="row">
            <h1 className="job-title-head d-md-none">
              <span>JOB POSTS</span>
            </h1>
          </div>
              ...
              {recruiters.map((recruiter, index) => (
                <div key={uuid()} className="row">
                  <div className="col-12 ">
                    {recruiter.jobPosts &&
                      recruiter.jobPosts.map((jp) => (
                        <div
                          key={uuid()}
                          className="one-jp border pl-3"
                  ...
                  <div className="col-12">
                    <div className="row px-2">
                      <div className="col-12 col-md-3 job-img-description">
                        ...
                        currentRecruiter.profileImg ? (
                          <img
                            className="jp-pic-current img-fluid"
                            src={`${currentRecruiter?.profileImg}`}
                            alt="company logo"
                          />
                        ) : (
                          <img
                            className="jp-pic img-fluid"
                            src={defaultPic}
                            alt="company logo"
                          />
                        )}
                      ...
                      <div className="col-12 col-md-9 job-summary-description">
                        <h5 className="jp-title-current">
                          {currentJobPost.title}
                        </h5>
                        <a
                          className="jp-company-current"
                          href={currentJobPost.url}
                          target="_blank"
                        >
                          {currentJobPost.companyName}
                        </a>
                        <p className="jp-loc-current">
                    ...
                    <div className="row">
                      <div className="col-12 col-md-6 mt-3 ml-1 text-center text-md-left">
                        {currentJobPost.url && (
                          <a href={currentJobPost.url} target="_blank">
                        ...
                        {userType === AUTH_TYPE_JOB_SEEKER && (
                          <button
                            className="btn btn-jp-apply font-weight-bolder"
                    ...
                    <p className="font-weight-bolder pb-2 m-0">
                      <u>Job Description</u>
                    </p>
                    <p className="jp-descr-current">
                      {" "}
