...
class Apply extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    const data = {
      ...
      emailDest: this.state.currentRecruiter.email,
    };
  ...
  render() {
    ...
    const { user, applyForm, fileToUpload, nextStep, steps, changeResume } =
      this.state;
    if (!user) {
      return null;
    }
          ...
          {!nextStep ? (
            <div>
              ...
              <div className="row">
                ...
                <div className="col p-0 pt-4">
                  <div className="">
                    <h6 className="apply-name-contact">
              ...
              <div className="row">
                <div className="col">
                  <div className="form-group">
                    ...
                    <input
                      type="email"
                      className="form-control form-control-sm input-apply"
                      required
                      value={applyForm.email}
                      onChange={(e) =>
                        this.handleFormChange({ email: e.target.value })
                      }
                    />
              ...
              <div className="row">
                <div className="col">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      this.handleFormChange({ phone: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <button
                type="button"
                className="btn float-right button-apply"
            ...
            <div>
              <div className="row mt-3">
                <div className="col">
                  <h5>Resume</h5>
                  <p className="form-text text-muted mb-1">
                    Please include a resume.
                  </p>
                  <label
                    className="label-upload mb-0 mr-2"
                    htmlFor="actual-btn"
                  >
                    Upload resume
                  ...
                  {user?.resume && !changeResume && (
                    <div className="pdf_icon">
                      <PictureAsPdfIcon className="mr-1" color="action" />
                      my resume
                    </div>
                  )}
              ...
              <div className="pt-5">
                ...
                <button
                  type="button"
                  className="btn btn-link button-back"
                  onClick={this.handleCurrentStep}
                >
                  Back
                </button>
                <button
                  type="submit"
                  className="btn btn-link button-apply float-right "
                >
                  Submit
                  <ArrowForwardIosIcon fontSize="small"></ArrowForwardIosIcon>
                </button>
