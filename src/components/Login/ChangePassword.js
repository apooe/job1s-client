      ...
      <Grid>
        <Paper elevation={10} id="paper-status">
          <Grid align="center">
            ...
            {error && (
              <FormHelperText className="text-center helper-text mb-2">
                {helperText}
              </FormHelperText>
            )}
            ...
            {step === 2 && (
              <div>
                <div className="text-left mb-2">
                  <small>
                    We sent you a verification code. Please enter it to confirm
                    your identity.
                  </small>
                </div>
                <TextField
            ...
            {step === 4 && <div className="mt-3"> Password changed !</div>}
          </Grid>
