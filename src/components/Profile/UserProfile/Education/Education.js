        ...
        <div className="row">
          <div className="col-md-12">
            <input
              type="text"
              onChange={(e) =>
                this.handleEducationChange({ collegeName: e.target.value })
              }
            ...
            <input
              type="text"
              onChange={(e) =>
                this.handleEducationChange({ degree: e.target.value })
              }
            ...
            <div className="input-group">
              <input
                type="month"
                onChange={(e) =>
                  this.handleEducationChange({ startDate: e.target.value })
                }
              ...
              <input
                type="month"
                onChange={(e) =>
                  this.handleEducationChange({ endDate: e.target.value })
                }
            ...
            <input
              type="text"
              onChange={(e) =>
                this.handleEducationChange({ link: e.target.value })
              }
              className="form-control w-100"
              placeholder="URL"
